...
client.on('message', function (message) {
    ...
    if (args[0].toLocaleLowerCase()=== prefix + "pingannounce"){
        ...
        let errormessage2 = new Discord.RichEmbed(":x: I can't send your announcement. I may not have the necessary permissions or the ``announcements'` channel does not exist on this server.")
